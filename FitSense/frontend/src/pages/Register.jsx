        ...
        <div style={{ 
            ...
            <div style={{ position: 'absolute', inset: 0, zIndex: -1 }}>
                <div style={{
                 ...
                 <div style={{
                    ...
                    background: 'radial-gradient(circle, rgba(200,100,255,0.2) 0%, transparent 70%)',
            ...
            >
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Create Account</h2>
                    <p style={{ color: 'var(--text-muted)' }}>Join the FitSense community today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    ...
                    >
                        {loading ? <Loader2 className="animate-spin" size={24} /> : <>Register <ArrowRight size={20} /></>}
                    </motion.button>
                </form>
                ...
                <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border-subtle)', textAlign: 'center' }}>
                    <p style={{ color: 'var(--text-muted)' }}>
                        ...
                        <Link to="/login" style={{ color: 'var(--primary)', fontWeight: 600, marginLeft: '0.5rem' }}>
                            Login
                        </Link>
                    </p>
                </div>
